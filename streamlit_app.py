...
st.set_page_config(page_title="IPC・FI改正状況チェック", page_icon="📊", layout="wide")
st.title("IPC・FI改正状況チェック")
st.caption("IPCまたはFIの改正情報と最新データを照合します。")
